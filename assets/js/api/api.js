(function($){
                ...
                success: function(data){
                    ...
                    $.ajax({
                        ...
                        success: function(data){ 
                            ...
                            info.append('file', $('#vehicule-picture').prop('files')[0] );
                            $.ajax({
                                url: automagno.ajaxurl,
                                method: 'post',
                                processData: false,
                                ...
                                success: function(response){
                                    ...
                                    var upload = new AWS.S3.ManagedUpload({
                                        params: {
                                            ...
                                            Key: response[0]['key'] + '.' + upFile.name.split('.').pop(),
                                            Body: upFile,
                                            ACL: response[0]['acl']
                                        },
                                        tags: [{Key: 'retomaId', Value: retomaId}],
                                    });
    ...
    {
        $('.wpcf7-form .wpcf7-pipes .wpcf7-select option').each(function(index,element) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for (var element in data){
                    $('#vehicule-categoria').prepend("<option value='" + element + "' >" + data[element] + "</option>");
                }
                $('#vehicule-categoria').prepend("<option value selected>-- Categoria --</option>");
            },
            error: function(error){
                console.log(error);
            }
        ...
        $.ajax({
            ...
            success: function(data){
                $('#vehicule-lugar_placa')
                    .find('option')
                    .remove()
                    .end()
                    ;
                for (var element in data){
                    $('#vehicule-lugar_placa').prepend("<option value='" + element + "' >" + data[element] + "</option>");
                }
                $('#vehicule-lugar_placa').prepend("<option value selected>-- Ciudad --</option>");
            },
            error: function(error){
                console.log(error);
            }
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            $('#vehicule-modelo')
                                ...
                                ;
                            for (var element in data){
                                $('#vehicule-modelo').prepend("<option value='" + element + "' >" + data[element] + "</option>");
                            }
                            $('#vehicule-modelo').prepend("<option value selected>-- Modelo --</option>");
                            $("#vehicule-marca").prop("disabled", true);
                            $("#vehicule-linea").prop("disabled", true);
                            $("#vehicule-version").prop("disabled", true);
                            $('#vehicule-marca')
                                ...
                                .end()
                                ;
                            $('#vehicule-marca').prepend("<option value selected>-- Marca --</option>");
                            $('#vehicule-linea')
                                .find('option')
                                .remove()
                                .end()
                                ;
                            $('#vehicule-linea').prepend("<option value selected>-- Linea --</option>");
                            $('#vehicule-version')
                                .find('option')
                                .remove()
                                .end()
                                ;
                            $('#vehicule-version').prepend("<option value selected>-- Versión --</option>");
                        },
                        error: function(error){
                            console.log(error);
                        }
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#vehicule-marca')
                        ...
                        ;
                    for (var element in data){
                        $('#vehicule-marca').prepend("<option value='" + element + "' >" + data[element] + "</option>");
                    }
                    $('#vehicule-marca').prepend("<option value selected>-- Marca --</option>");
                    $("#vehicule-linea").prop("disabled", true);
                    $("#vehicule-version").prop("disabled", true);
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#vehicule-linea')
                        ...
                        ;
                    for (var element in data){
                        $('#vehicule-linea').prepend("<option value='" + element + "' >" + data[element] + "</option>");
                    }
                    $('#vehicule-linea').prepend("<option value selected>-- Linea --</option>");
                    $("#vehicule-version").prop("disabled", true);
                    $('#vehicule-version')
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#vehicule-version')
                        ...
                        ;
                    for (var element in data){
                        $('#vehicule-version').prepend("<option value='" + element + "' >" + data[element] + "</option>");
                    }
                    $('#vehicule-version').prepend("<option value selected>-- Versión --</option>");
                },
                error: function(error){
