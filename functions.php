...
wp_register_script('AWS', 'https://sdk.amazonaws.com/js/aws-sdk-2.809.0.min.js', null, null, true );
wp_enqueue_script('AWS');

function assets(){
	wp_enqueue_script('api', get_template_directory_uri().'/assets/js/api/api.js', '', '1.0', true);
	wp_localize_script('api', 'automagno', array('ajaxurl' => admin_url('admin-ajax.php')));
}
