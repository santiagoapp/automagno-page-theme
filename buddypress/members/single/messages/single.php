<div id="message-thread" role="main">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<?php while ( bp_thread_messages() ) : bp_thread_the_message(); ?>
			...
			<div class="message-box <?php bp_the_thread_message_alt_class(); ?>">
				...
				<div class="message-metadata">
					...
					<?php bp_the_thread_message_sender_avatar( 'type=thumb&width=25&height=25' ); ?>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form x-send-reply-form cf">
			...
			<div class="message-content">
				...
				<div class="submit">
					<input type="submit" name="send" value="<?php esc_attr_e( 'Reply', '__x__' ); ?>" id="send_reply_button"/>
				</div>
