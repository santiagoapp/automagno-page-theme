...
if ( ! function_exists( 'x_ethos_category_accent_color' ) ) :
  function x_ethos_category_accent_color( $category_id, $fallback_color = '#ffffff' ) {
    ...
    $accent    = ( isset($term_meta['accent']) && $term_meta['accent'] != '' ) ? $term_meta['accent'] : $fallback_color;
...
function x_ethos_comment_form_fields( $fields ) {
...
add_filter('comment_form_default_fields', 'x_ethos_comment_form_fields' );
